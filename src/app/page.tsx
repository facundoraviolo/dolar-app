import { fetchDolarMep } from './lib/fetchDolarMep';
...
export default async function Home() {
  const dolarMep = await fetchDolarMep();
    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-4 bg-gradient-to-br from-emerald-950 to-green-900">
      ...
      <Suspense fallback={<Loading />}>
        <Converter
          ...
          fechaActualizacion={dolarMep.fechaActualizacion}
        />
      </Suspense>

      <footer className="mt-8 text-center text-sm text-white">
        <p>Datos proporcionados por <a href="https://dolarapi.com/" target="_blank" rel="noopener noreferrer" className="text-green-500 hover:text-green-400 transition-colors">DolarAPI.com</a></p>
      </footer>
    </main>
  );
}
